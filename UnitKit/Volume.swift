...
public enum Volume {
    ...
    public static let CubicCentimeter = Unit<Volume>(name: "Cubic Centimeters", symbol: "cm^3", ratio: 1e-6)
    ...
    public static let CubicMeter = Unit<Volume>(name: "Cubic Meters", symbol: "m^3", ratio: 1)
